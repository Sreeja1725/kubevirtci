 ...
 *
 *   - lspci (with -D); they show up as "Unknown vendor / Unknown device"
 *     because 0xe1a5 is unassigned in the public pci.ids database
 ...
 * 0xe1a5 / 0xd0c5 are unassigned in the public pci.ids database, so
 * lspci shows them as "Unknown vendor / Unknown device" - obvious for
 * an example module - and they cannot collide with any real hardware
 * on the host. Override via module parameters when a specific
